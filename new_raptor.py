...
/***************************************************************************
 ...
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
        ...
        begin                : 2021-08-13
        git sha              : $Format:%H$
        copyright            : (C) 2021 by HomeTown
        email                : eng.momen3@gmail.com
 ***************************************************************************/
...
class NewRaptor:
    ...
    def run(self):
        ...
        if self.first_start == True:
            ...
            #QMessageBox.information(self.dlg, "Message", "Should run only once")
        ...
        y = self.dlg.spbLatitude.setValue(mc.center().y())
        x = self.dlg.spbLongitude.setValue(mc.center().x())
        data = self.dlg.dteLast.setDate(QDate.currentDate())
        ...
        if result:
            ...
            print(valLat, valLng, valSpecies, valBuffer, valStatus, valLast)
            ftrNest = QgsFeature(lyrNests.fields())
            ftrNest.setAttribute("lat_y_dd", valLat)
            ftrNest.setAttribute("long_x_dd", valLat)
            ftrNest.setAttribute("Species", valSpecies)
            ftrNest.setAttribute("buf_dist", valBuffer)
            ftrNest.setAttribute("Status", valStatus)
            ftrNest.setAttribute("Last Survey", valLast)
            ftrNest.setAttribute("Nest ID", valNestID)
